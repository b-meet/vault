...
import { clearUserSession, extractUserData, saveUserSession } from '../../utility/userSession';
import { createUserWithEmailAndPassword, getIdToken, onAuthStateChanged, GoogleAuthProvider, signInWithEmailAndPassword, signInWithPopup, signOut, updateProfile } from 'firebase/auth';
import { auth } from '../../firebase/firebaseConfig';
import { SESSION_TIMEOUT, STORAGE_KEYS } from '../../constants';
import { storage } from '../../utility/storageService';
import type { AuthCheckResponse, LoginCredentials, SignupCredentials } from '../types';
...
export const signupWithEmail = createAsyncThunk(
  ...
  async ({ email, password, displayName }: SignupCredentials, { rejectWithValue }) => {
    try {
